...
--  COMPLETE SCHEMA WITH PROPER IF EXISTS HANDLING
--
--  ⚠️ USE THIS FILE - IT HANDLES ALL CONFLICTS
--  Safe to run multiple times
-- ============================================================

-- ============================================================
--  DROP CONFLICTING PUBLICATIONS FIRST
-- ============================================================
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM pg_publication_tables
               WHERE pubname='supabase_realtime' AND tablename='offer_campaigns') THEN
        ALTER PUBLICATION supabase_realtime DROP TABLE offer_campaigns;
    END IF;
    IF EXISTS (SELECT 1 FROM pg_publication_tables
               WHERE pubname='supabase_realtime' AND tablename='campaign_notifications') THEN
        ALTER PUBLICATION supabase_realtime DROP TABLE campaign_notifications;
    END IF;
    IF EXISTS (SELECT 1 FROM pg_publication_tables
...
-- ============================================================
--  DROP EXISTING TABLES (IF THEY EXIST WITH CONFLICTS)
-- ============================================================
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables
               WHERE table_schema='public' AND table_name='campaign_notifications') THEN
        DROP TABLE IF EXISTS campaign_notifications CASCADE;
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.tables
               WHERE table_schema='public' AND table_name='commission_ledger') THEN
    ...
    END IF;
    IF EXISTS (SELECT 1 FROM information_schema.tables
               WHERE table_schema='public' AND table_name='offer_campaigns') THEN
...
-- ============================================================
--  5. OFFER_CAMPAIGNS TABLE (FRESH CREATE)
-- ============================================================
...
-- ============================================================
--  6. CAMPAIGN_NOTIFICATIONS TABLE (FRESH CREATE)
-- ============================================================
...
-- ============================================================
--  7. COMMISSION_LEDGER TABLE (FRESH CREATE)
-- ============================================================
...
-- ============================================================
--  8. WALLET_TRANSACTIONS TABLE (FRESH CREATE)
-- ============================================================
